...
public class DataPreparer {
    ...
    private final Logger logger = LoggerFactory.getLogger(DataPreparer.class);
    ...
    public DataPreparer(int height, int width, int channels, int batchSize, int outputNum) {
        this.height = height;
        this.width = width;
