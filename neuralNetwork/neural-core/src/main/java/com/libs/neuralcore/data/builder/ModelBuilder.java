...
public class ModelBuilder {
    ...
    private final Logger logger = LoggerFactory.getLogger(ModelBuilder.class);
    ...
    public ModelBuilder(int height, int width, int channels, int numEpochs, int outputNum) {
        this.height = height;
        this.width = width;
